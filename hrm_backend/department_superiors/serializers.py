...
class Department_Superior_WriteSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        dept_superior_id = Department_Superior.objects.create(
            dept = dept,
            position = position,
            **validated_data
        )

        return dept_superior_id
    ...
    def update(self, instance, validated_data):
        ...
        if dept_name:
            dept, _ = Department.objects.get_or_create(dept_nam = dept_name)
            instance.dept = dept
...
# for history, although just specific departments not over all history of departemnts superior
